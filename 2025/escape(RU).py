...
objects = {
    ...
    23: [images.door, images.door_shadow, "Запертая дверь. Нужна " \
         f"карта доступа твоего первого друга ({FRIEND1_NAME})."],
    24: [images.door, images.door_shadow, "Запертая дверь. Нужна " \
         f"карта доступа твоего второго друга ({FRIEND2_NAME})."],
    ...
    76: [images.scissors, None, "Ножницы. Они слишком тупые, чтобы что-то резать. \
     Ты сможешь их наточить?", "Тупые ножницы."],
